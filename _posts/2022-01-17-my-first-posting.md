---
layout: single
title:  "Github Blog 첫 글 올리기, 그 험난함 (깃헙블로그 포스팅 에러)"
---
...
<img src="\images\first-1.png" width="60%" title="수정화면"></img>


## 다음에 표시된 내용들을 주의하면 실패할 확률이 줄어든다.
(나는 무려 2, 3, 4, 5, 6번 항목에서 하나씩 문제가 있었다. 🤣🤣🤣)

<img src="\images\first-2.png" width="60%" title="수정화면 표시"></img>
...
<img src="images\first-3.png" width="60%" title="Actions"></img>

이렇게 실행 실패한 경우에는 딱 티가난다. 

클릭하면 자세한 내용을 확인할 수 있다.

<img src="images\first-4.png" width="60%" title="Actions_detail"></img>
